...
export class DataProcesser {
    ...
    static async processOBJFarthestPoint(url1, url2) {
        ...
        console.log(blade1FarPoint, blade2FarPoint, 'farthest points');
        const cameraIntersectionData = FaceExtractor.getCameraData(
            intersectionPoint,
            highest1,
            highest2,
        ...
        const data = {
            ...
            Blade1Angle: blade1FarPoint.deg,
            Blade2Top: highest2.toArray(),
            Blade2Bottom: lowest2.toArray(),
            ...
            Blade2Angle: blade2FarPoint.deg,
            Blade1LocalTop: localHighest.toArray(),
            Blade1LocalBottom: localLowest.toArray(),
            Blade2LocalTop: localHighest2.toArray(),
            Blade2LocalBottom: localLowest2.toArray(),
    ...
    static async processSingleBlade(url) {
        ...
        const data = {
            ...
            BladeLocalTop: highestOrig.toArray(),
            BladeLocalBottom: lowestOrig.toArray(),
            BladeFarthestPoint1: farthest1?.toArray() ?? null,
            BladeFarthestPoint2: farthest2?.toArray() ?? null,
            BladeLocalFarthestPoint1: farthest1Orig?.toArray() ?? null,
            BladeLocalFarthestPoint2: farthest2Orig?.toArray() ?? null,
            BladeFarDistance: farthestDistance,
    ...
    static findFarthestPoints(mesh, points, midPlane) {
        ...
        const localIntersectionPoint = perpendicularPoint.map((v) => v.clone());
